...
breaks <- c('initial', 'bo', 'bo.oak.20', 'bo.oak.25', 'nelder-mead', 'annealing', 'pso')
colors <- c('black', '#f8766d', '#c8463d', 'yellow', '#619cff', '#00ba38', '#f752df')
