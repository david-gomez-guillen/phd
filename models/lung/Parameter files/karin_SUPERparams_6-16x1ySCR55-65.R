ALL.PARAMETERS <- list(
list(sim.name="1xBI @55 (18%) + 1y-xSCR-HR @55 (18%)",
...
################################################################################
  ...
  list(sim.name="2xBI @55&60 (18%) + 1y-xSCR-HR @55 (18%)",
       interventions_p=list(diag_screen=c(0,0.604,0.604,0.604,0,0,0),
                            diag_spont= c(5e-8,1e-5,1e-4,1e-3,0,0,0),
  ...
  list(sim.name="3xBI @55&60&65 (18%) + 1y-xSCR-HR @55 (18%)",
       interventions_p=list(diag_screen=c(0,0.604,0.604,0.604,0,0,0),
                            diag_spont= c(5e-8,1e-5,1e-4,1e-3,0,0,0),
  ...
  list(sim.name="3xBI @55&56&57 (18%) + 1y-xSCR-HR @55 (18%)",
       interventions_p=list(diag_screen=c(0,0.604,0.604,0.604,0,0,0),
                            diag_spont= c(5e-8,1e-5,1e-4,1e-3,0,0,0),
...
list(sim.name="1xBI @35 (18%) + 1y-xSCR-HR @55 (18%)",
     interventions_p=list(diag_screen=c(0,0.604,0.604,0.604,0,0,0),
                          diag_spont= c(5e-8,1e-5,1e-4,1e-3,0,0,0),
...
list(sim.name="2xBI @35&40 (18%) + 1y-xSCR-HR @55 (18%)",
     interventions_p=list(diag_screen=c(0,0.604,0.604,0.604,0,0,0),
                          diag_spont= c(5e-8,1e-5,1e-4,1e-3,0,0,0),
...
list(sim.name="2xBI @35&55 (18%) + 1y-xSCR-HR @55 (18%)",
     interventions_p=list(diag_screen=c(0,0.604,0.604,0.604,0,0,0),
                          diag_spont= c(5e-8,1e-5,1e-4,1e-3,0,0,0),
...
list(sim.name="3xBI @35&40&45 (18%) + 1y-xSCR-HR @55 (18%)",
     interventions_p=list(diag_screen=c(0,0.604,0.604,0.604,0,0,0),
                          diag_spont= c(5e-8,1e-5,1e-4,1e-3,0,0,0),
...
list(sim.name="1xII @55 (18%) + 1y-xSCR-HR @55 (18%)",
     interventions_p=list(diag_screen=c(0,0.604,0.604,0.604,0,0,0),
                          diag_spont= c(5e-8,1e-5,1e-4,1e-3,0,0,0),
...
list(sim.name="2xII @55&60 (18%) + 1y-xSCR-HR @55 (18%)",
     interventions_p=list(diag_screen=c(0,0.604,0.604,0.604,0,0,0),
                          diag_spont= c(5e-8,1e-5,1e-4,1e-3,0,0,0),
...
list(sim.name="3xII @55&60&65 (18%) + 1y-xSCR-HR @55 (18%)",
     interventions_p=list(diag_screen=c(0,0.604,0.604,0.604,0,0,0),
                          diag_spont= c(5e-8,1e-5,1e-4,1e-3,0,0,0),
...
list(sim.name="3xII @55&56&57 (18%) + 1y-xSCR-HR @55 (18%)",
     interventions_p=list(diag_screen=c(0,0.604,0.604,0.604,0,0,0),
                          diag_spont= c(5e-8,1e-5,1e-4,1e-3,0,0,0),
...
list(sim.name="1xII @35 (18%) + 1y-xSCR-HR @55 (18%)",
     interventions_p=list(diag_screen=c(0,0.604,0.604,0.604,0,0,0),
                          diag_spont= c(5e-8,1e-5,1e-4,1e-3,0,0,0),
...
list(sim.name="2xII @35&40 (18%) + 1y-xSCR-HR @55 (18%)",
     interventions_p=list(diag_screen=c(0,0.604,0.604,0.604,0,0,0),
                          diag_spont= c(5e-8,1e-5,1e-4,1e-3,0,0,0),
...
list(sim.name="2xII @35&55 (18%) + 1y-xSCR-HR @55 (18%)",
     interventions_p=list(diag_screen=c(0,0.604,0.604,0.604,0,0,0),
                          diag_spont= c(5e-8,1e-5,1e-4,1e-3,0,0,0),
...
list(sim.name="3xII @35&40&45 (18%) + 1y-xSCR-HR @55 (18%)",
     interventions_p=list(diag_screen=c(0,0.604,0.604,0.604,0,0,0),
                          diag_spont= c(5e-8,1e-5,1e-4,1e-3,0,0,0),
