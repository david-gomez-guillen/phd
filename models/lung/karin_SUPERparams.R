ALL.PARAMETERS <- list(
  list(sim.name="3xII @35&40&45 (18%, eff -75%) + 3y-xSCR-HR @55 (18%)",
  ...
  list(sim.name="3xII @35&40&45 (18%, eff -50%) + 3y-xSCR-HR @55 (18%)",
       interventions_p=list(diag_screen=c(0,0.604,0.604,0.604,0,0,0),
                            diag_spont= c(5e-8,1e-5,1e-4,1e-3,0,0,0),
                            ...
                            quitting_interventions = list(list(
                              ...
                              # coverage     = .1869*(1-.2),
                              # success_rate = .2,
                              coverage     = .1869*(1-.1989),
                              success_rate = .1989,
                              interv_steps = 1+12*5
                            ), list(
                              # coverage     = .1869*(1-.2)*(1-.2),
                              # success_rate = .2,
                              coverage     = .1869*(1-.1989)*(1-.1989),
                              success_rate = .1989,
                              interv_steps = 1+12*10
                            )
                            ),
  ...
  list(sim.name="3xII @35&40&45 (18%, eff +50%) + 3y-xSCR-HR @55 (18%)",
       interventions_p=list(diag_screen=c(0,0.604,0.604,0.604,0,0,0),
                            ...
                            quitting_interventions = list(list(
                              ...
                              # coverage     = .1869*(1-.2),
                              # success_rate = .2,
                              coverage     = .1869*(1-.5966),
                              success_rate = .5966,
                              interv_steps = 1+12*5
                            ), list(
                              # coverage     = .1869*(1-.2)*(1-.2),
                              # success_rate = .2,
                              coverage     = .1869*(1-.5966)*(1-.5966),
                              success_rate = .5966,
                              interv_steps = 1+12*10
                            )
                            ),
  ...
  list(sim.name="3xII @35&40&45 (18%, eff +75%) + 3y-xSCR-HR @55 (18%)",
       interventions_p=list(diag_screen=c(0,0.604,0.604,0.604,0,0,0),
                            ...
                            quitting_interventions = list(list(
                              ...
                              # coverage     = .1869*(1-.2),
                              # success_rate = .2,
                              coverage     = .1869*(1-.6960),
                              success_rate = .6960,
                              interv_steps = 1+12*5
                            ), list(
                              # coverage     = .1869*(1-.2)*(1-.2),
                              # success_rate = .2,
                              coverage     = .1869*(1-.6960)*(1-.6960),
                              success_rate = .6960,
                              interv_steps = 1+12*10
                            )
                            ),
  ...
  list(sim.name="3xII @35&40&45 (18%, eff -75%) + 3y-xSCR-HR @55 (18%, eff -75%)",
       interventions_p=list(diag_screen=c(0,0.151,0.151,0.151,0,0,0),
                            diag_spont= c(5e-8,1e-5,1e-4,1e-3,0,0,0),
  ...
  list(sim.name="3xII @35&40&45 (18%, eff -50%) + 3y-xSCR-HR @55 (18%, eff -50%)",
       interventions_p=list(diag_screen=c(0,0.302,0.302,0.302,0,0,0),
                            diag_spont= c(5e-8,1e-5,1e-4,1e-3,0,0,0),
  ...
  list(sim.name="3xII @35&40&45 (18%, eff +50%) + 3y-xSCR-HR @55 (18%, eff +50%)",
       interventions_p=list(diag_screen=c(0,0.906,0.906,0.906,0,0,0),
                            diag_spont= c(5e-8,1e-5,1e-4,1e-3,0,0,0),
  ...
  list(sim.name="3xII @35&40&45 (18%, eff +75%) + 3y-xSCR-HR @55 (18%, eff +75%)",
       interventions_p=list(diag_screen=c(0,1,1,1,0,0,0),
                            diag_spont= c(5e-8,1e-5,1e-4,1e-3,0,0,0),
  ...
  list(sim.name="3xII @35&40&45 (18%) + 3y-xSCR-HR @55 (18%, eff -75%)",
       interventions_p=list(diag_screen=c(0,0.151,0.151,0.151,0,0,0),
                            diag_spont= c(5e-8,1e-5,1e-4,1e-3,0,0,0),
  ...
  list(sim.name="3xII @35&40&45 (18%) + 3y-xSCR-HR @55 (18%, eff -50%)",
       interventions_p=list(diag_screen=c(0,0.302,0.302,0.302,0,0,0),
                            diag_spont= c(5e-8,1e-5,1e-4,1e-3,0,0,0),
