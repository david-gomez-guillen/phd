...
conIni=c(x[[9]][1,2],0.001,x[[9]][2,3],x[[9]][2,4],x[[9]][2,5],x[[9]][2,6],x[[9]][3,4],x[[9]][3,5],x[[9]][3,6],x[[9]][4,5],x[[9]][4,6])
...
plot(y,lcmort,"o",col="red", xlab="age group", ylab="incidence")
lines(y,real.lcmort,"o",col="blue", xlab="age group", ylab="incidence")

plot(y,othermort,"o",col="red", xlab="age group", ylab="incidence")
